  ...
  return (
    <div className=' w-full h-auto p-8 '>
            <div id='about' className=' h-auto rounded sm:flex sm:flex-col md:flex md:flex-row '>
                  ...
                  <div id='right' className='w-full h-auto flex flex-col gap-4  p-4  bg-blue-300'>
                    ...
                    <div id='myself' className='w-full h-auto rounded-2xl p-4 bg-[#F5F5F5]'>
                      ...
                      <br />
                    <h3 className='text-xl font-bold'>Hi, I'm Mayank Shahi, a passionate front-end developer with a keen interest in crafting engaging and user-friendly web experiences. Proficient in JavaScript and experienced in building responsive web applications using React.js.
                    <br />
